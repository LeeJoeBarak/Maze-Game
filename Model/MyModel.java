...
public class MyModel extends Observable implements IModel {
    ...
    public void generateMaze(int numOfRows, int numOfCols) {
        ...
        /* Notify ViewModel */
        notifyObservers("mazeGenerated");//todo if not running properly: change notifyObservers() to notifyObservers(Object) and pass the Maze/Solution itself
   ...
   @Override
    ...
    public void loadMaze(File file){
        ...
        try {
            ...
            br.close();
            Position startPos = new Position(playerRowIdx, playerColIdx);
            Position goalPos  = new Position(goalRowIdx, goalColIdx);
            this.grid = grid;
            this.maze = new Maze(grid, startPos, goalPos);
